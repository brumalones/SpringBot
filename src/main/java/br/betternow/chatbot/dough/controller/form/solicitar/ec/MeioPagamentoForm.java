...
public class MeioPagamentoForm extends GenericForm {

    public MeioPagamentoForm() {
    }
    ...
    public ConversationReference update(String uuid, ConversationReferenceRepository referenceRepository) {
        ...
        attributes.put(SolicitarEcChavesEnum.meioPgtoEC.toString(), SolicitarEcValoresEnum.fromText(this.chosen).toString());
