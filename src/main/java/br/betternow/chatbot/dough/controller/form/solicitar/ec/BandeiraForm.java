...
public class BandeiraForm extends GenericForm {
    ...
    public ConversationReference update(String uuid, ConversationReferenceRepository referenceRepository) {
        ...
        attributes.put(SolicitarEcChavesEnum.bandeiraEC.toString(), SolicitarEcValoresEnum.fromText(this.chosen).toString());
